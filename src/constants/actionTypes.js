...
export const ADD_MAIN_PLAN = 'ADD_MAIN_PLAN';
export const ADD_MAIN_PLAN_SUCCESS = 'ADD_MAIN_PLAN_SUCCESS';
export const UPDATE_MAIN_PLAN = 'UPDATE_MAIN_PLAN';
export const DELETE_MAIN_PLAN = 'DELETE_MAIN_PLAN';
export const DELETE_MAIN_PLAN_SUCCESS = 'DELETE_MAIN_PLAN_SUCCESS';
...
export const RESET_POLICIES_CHANGED = "RESET_POLICIES_CHANGED";
