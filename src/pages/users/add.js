...
class Add extends Component {
    ...
    onSubmitHandler = (e, v) => {
        ...
        this.props.addUser(v.fullName, v.username, v.role, v.password, v.emailAddress, v.mobileNumber);
    };
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <AvForm onValidSubmit={this.onSubmitHandler}>
                                        ...
                                        <AvField name="emailAddress" label="Email Address" placeholder="Enter your email address"
                                                 value={this.props.user.emailAddress} required/>
                                        
                                        <AvField name="mobileNumber" label="Mobile Number" placeholder="Enter your mobile number"
                                                 value={this.props.user.mobileNumber} required/>
...
const mapStateToProps = (state) => {
    const { user, userAdded, loading, error } = state.User;
    return { user, userAdded, loading, error };
};

export default connect(mapStateToProps, { addUser, getUser })(Add);
