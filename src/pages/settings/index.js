...
class Settings extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.setting !== this.props.setting) {
      this.setState({
        ...
        default_early_critical_illness:
          nextProps.setting.default_early_critical_illness,
        ...
        default_accidental_disability:
          nextProps.setting.default_accidental_disability,
    ...
    if (nextProps.user !== this.props.user) {
      this.setState({
        ...
        accidental_reimbursement:
          nextProps.user.financial.accidental_reimbursement,
        categories: nextProps.user.categories,
        company: nextProps.user.company
          ? nextProps.user.company
          : this.state.company
      });
    }
  }
  ...
  deleteCategory(c) {
    ...
    const tmpCategory = this.state.categories.filter(
      category => category !== c
    );
    ...
    this.props.updateAccountCategories(
      this.state.user.id,
            ...
            <NavItem>
              <NavLink
                className={classnames({
                  active: this.props.active === "financial"
                })}
          ...
          <TabContent activeTab={this.props.active}>
            <TabPane tabId="financial">
              <Form onSubmit={this.onFinancialSubmitHandler}>
                ...
                <FormGroup row>
                  <Label for="exampleEmail" lg={{ size: 2, offset: 1 }}>
                    Death
                  </Label>
                  <Col sm={2}>
                    <Input
                ...
                <FormGroup row>
                  <Label for="critical_illness" lg={{ size: 2, offset: 1 }}>
                    Critical illness
                  </Label>
                  <Col sm={2}>
                    <Input
                  ...
                  <Label for="critical_illness" lg={{ size: 1 }}>
                    X
                  </Label>
                  <Label for="critical_illness" lg={{ size: 1 }}>
                    of annual income
                ...
                <FormGroup row>
                  <Label for="disability_income" lg={{ size: 2, offset: 1 }}>
                    Disability Income
                  </Label>
                  <Col sm={2}>
                    <Input
                      ...
                      placeholder="Disability Income"
                      onChange={this.onChangeHandler}
                      value={this.state.disability_income / 100}
                    />
                  </Col>
                  <Label for="disability_income" lg={{ size: 1 }}>
                    X
                  </Label>
                  <Label for="disability_income" lg={{ size: 1 }}>
                    of month income
                ...
                <Row style={{ marginBottom: 15 }}>
                  <Col lg={{ size: 2, offset: 1 }}>
                    <Label style={{ fontSize: 20 }}>
                      <b>Accident Protection</b>
                    </Label>
                  </Col>
                </Row>
                <FormGroup row>
                  <Label for="accidental_death" lg={{ size: 2, offset: 1 }}>
                    Accidental Death
                  </Label>
                  <Label
                    for="accidental_reimbursement"
                    style={{ marginTop: 7 }}
                  >
                    $
                  </Label>
                ...
                <FormGroup row>
                  ...
                  <Col sm={2}>
                    <Input
                      type="number"
                      name="accidental_disability"
                      id="accidental_disability"
                      placeholder="Accidental Disability"
                      onChange={this.onChangeHandler}
                ...
                <FormGroup row>
                  ...
                  <Col sm={2}>
                    <Input
                      type="number"
                      name="accidental_reimbursement"
                      id="accidental_reimbursement"
                      placeholder="Accidental Reimbursement"
                      onChange={this.onChangeHandler}
                ...
                <FormGroup row>
                  <Col sm={2}>
                    <button
                      ...
                      style={{ marginLeft: 140, marginTop: 40, width: 90 }}
                    >
                      Save
                    </button>
                  </Col>
                          ...
                          this.props.companies.map((company, i) => (
                            <tr key={i}>
                              ...
                              <td>
                                <button type="button" class="btn btn-link"
                                  onClick={() => {
                                    this.props.history.push(`/settings/${company._id}/edit-company`);
                                  }}
                                >Edit</button>
                                <button type="button" class="btn btn-link"
